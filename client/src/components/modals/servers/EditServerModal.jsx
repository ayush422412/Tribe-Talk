...
import { closeEditServer } from "../../../store/slices/uiSlice.js";
...
export function EditServerModal() {
  ...
  const iconPreview = useMemo(() => iconFile ? URL.createObjectURL(iconFile) : toImageUrl(form.iconUrl), [iconFile, form.iconUrl]);
  ...
  async function handleSubmit(event) {
    ...
    const iconUrl = iconFile ? (await uploadImage(iconFile).unwrap()).url : form.iconUrl;
    await updateServer({ serverId: currentServerId, ...form, iconUrl }).unwrap();
    setIconFile(null);
